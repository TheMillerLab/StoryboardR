#' Shift dates a number of days, bizdays, months, weeks or years. This code was taking directly from TimeWarp, since it is no longer on CRAN
#' @description
#' `dateShift()` shifts dates a number of days, bizdays, months, weeks or years.
#' @export
